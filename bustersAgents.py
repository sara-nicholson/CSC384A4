...
class GreedyBustersAgent(BustersAgent):
	...
	for i in range(len(livingGhostPosDist)):
	    ...
	    likelyPos = max(livingGhostPosDist[i],key=livingGhostPosDist[i].get)
	    #print likelyPos	
	...
	for act in legal:
	    ...
	    distToGhost = self.distancer.getDistance(closest_ghost,successorPosition)
	...
	#then loop through all the actions and see which one minimizes the distance to the closest ghost
